        ...
        <?php foreach ($products as $p): $s = isset($stock[$p['id']]) ? $stock[$p['id']] : 0; ?>
            <div class="goods-card">
                <div class="goods-head">
                    <span class="goods-cat"><?php if (!empty($p['icon'])): ?><img src="<?= e(site_url(product_image_url($p['icon'], 'thumb'))) ?>" alt="" style="width:16px;height:16px;object-fit:cover;border-radius:4px;vertical-align:-3px;margin-right:5px" loading="lazy"><?php endif; ?><?= e($p['name']) ?></span>
