<?php
/**
 * 码支付插件(易支付协议 submit接口)
 * 接口文档: https://xpay.shw1.com/doc/epay_submit
 */
class CodepayPlugin extends PaymentBase
{
    public function fields()
    {
        return [
            ['key' => 'gateway', 'label' => '码支付网关', 'type' => 'text', 'default' => 'https://xpay.shw1.com', 'desc' => '码支付平台地址, 默认 https://xpay.shw1.com'],
            ['key' => 'pid', 'label' => '商户ID(pid)', 'type' => 'text', 'default' => '', 'desc' => '码支付平台的商户ID'],
            ['key' => 'key', 'label' => '商户密钥(KEY)', 'type' => 'text', 'default' => '', 'desc' => '码支付平台商户通信密钥'],
    ...
    {
        $gateway = $this->cfg('gateway', 'https://xpay.shw1.com');
