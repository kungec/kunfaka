...
<style>
.pf-wrap{max-width:960px;display:grid;grid-template-columns:300px minmax(0,1fr);gap:16px;align-items:start}
@media (max-width:1000px){.pf-wrap{grid-template-columns:1fr}}
.pf-id{display:flex;flex-direction:column;align-items:center;text-align:center;gap:12px;padding:26px 18px 22px}
.pf-id .avatar{width:76px;height:76px;border-radius:22px;background:linear-gradient(135deg,#a8c7fa,#8ab4f8);color:#0e2242;display:inline-flex;align-items:center;justify-content:center;font-weight:800;font-size:30px;box-shadow:0 10px 26px -10px rgba(138,180,248,.6)}
html[data-theme="light"] .pf-id .avatar{background:linear-gradient(135deg,#3b82f6,#2563eb);color:#fff;box-shadow:0 10px 26px -10px rgba(37,99,235,.55)}
.pf-id .nm{font-size:16px;font-weight:800}
.pf-id .rl{margin-top:4px}
.pf-rows{width:100%;display:flex;flex-direction:column;gap:0;margin-top:4px}
.pf-row{display:flex;justify-content:space-between;gap:10px;padding:8px 2px;border-top:1px dashed var(--input-border);font-size:12px}
...
.pf-form h3{font-size:14px;margin-bottom:16px}
...
.pf-form .ops{display:flex;gap:9px;margin-top:18px}
